...
export const LaserFlow: React.FC<LaserFlowProps> = ({
  ...
  useEffect(() => {
    ...
    const { r, g, b } = hexToRGB(color || '#F59E0B');
    ...
    // Global pointer move on window so beam reacts even when cursor is over content
    const onWindowPointerMove = (ev: MouseEvent | PointerEvent) => {
